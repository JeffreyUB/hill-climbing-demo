...
def get_elevation(coords: list, url="https://api.open-elevation.com/api/v1/lookup"):
# {
#    "results":
#    [
#       {
...
def build_coords(lat, lon, n_points=20, span=0.02):
...
# }"
    ...
    for response in data["results"]:
        ...
        latitudes = response.get("latitude")
        results.append(longitude, elevation, latitudes)
    pass
